...
function pred_out = run_lsc_prediction_user(data_obs, pred_data, fit, reg_rel)
%RUN_LSC_PREDICTION_USER Run LSC prediction for user-supplied prediction points

if nargin < 4 || isempty(reg_rel)
    reg_rel = 1e-10;
end
